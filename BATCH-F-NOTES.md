...
- The operations audit now fails if any Global path calls the private-pool player collection loader. Global live standings continue to use the single trusted standings document and the viewer's own bounded row.
