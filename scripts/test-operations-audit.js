...
assert(firebaseConfig.includes("script-src 'self' 'unsafe-inline' https://www.gstatic.com https://apis.google.com https://plausible.io"),'The production CSP must allow the Firebase Auth Google API script.');
